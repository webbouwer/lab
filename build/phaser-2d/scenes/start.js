class GameStart extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('bg_start', 'media/bg/pixel_floating_islands.png');
    this.load.image('platform_start', 'media/objects/pixel_platform_medium_green1.png');
    this.load.image('ground_start', 'media/objects/pixel_ground_green1.png');

    this.load.image('woodblock', 'media/objects/pixel_woodblock.png');

    this.load.spritesheet('bunny', 'media/sprites/pixel_bunny_sprite.png', {
      frameWidth: 80,
      frameHeight: 80
    });

    this.load.spritesheet('dust_light', 'media/sprites/pixel_dustcloud_light.png', {
      frameWidth: 60,
      frameHeight: 40
    });

    this.load.spritesheet('arrows', 'media/sprites/pixel_arrow_controls.png', {
      frameWidth: 60,
      frameHeight: 70
    });
