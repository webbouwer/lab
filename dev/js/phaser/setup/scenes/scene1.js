...
class GameScene1 extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet('nabi', 'https://oddsized.com/dev/lib/media/anima/nabi_phaser.png', {
      frameWidth: 64,
      frameHeight: 96
    });
	...
	this.load.image('toolbox', 'https://oddsized.com/dev/lib/media/anima/wdh_toolbox.png');
  }
