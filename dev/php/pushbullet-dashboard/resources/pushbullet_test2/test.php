...
try {
  ...
  $p->pushNote('oddsized@gmail.com', 'Hey!', 'It works!');
  ...
  $p->pushNote(NULL, 'Push this OK', 'This is a pushbullet test to all connected devices');
